...
known_dims = None # known dimensions of the rectangular plane as [width, height] in meters. If set to None, dimensions will be estimated.
...
# save folder string
save_dir = f"RecSeg3D_results/session_{date_time}"
